...
const Review2 = ({ onViewReview2 }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Review 2 Submission Response:", response.data);
        ...
        <div className="rect66">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              name="githubLink"
              className="revinput"
              placeholder="NA or GitHub Link here"
            ...
            <input
              ...
              name="figmaLink"
              className="revinput"
              placeholder="NA or Figma Link here"
              onChange={handleChange}
              value={formData.figmaLink}
            />
            <label htmlFor="otherlink" className="revlab">
              Google Drive Link (Flowchart, Circuit Diagram)
            </label>
            <input
              required
              type="text"
            ...
            <input
              ...
              name="deploymentLink"
              className="revinput"
              placeholder="NA or Project Link Here"
              onChange={handleChange}
